...
این برد توسعه، طراحی کلاسیک [NodeMCU 1.0](https://en.wikipedia.org/wiki/NodeMCU) را حفظ کرده و بیشتر پایه‌های ورودی/خروجی را به هدرهای دو طرف برد منتقل کرده است. به این ترتیب، توسعه‌دهندگان می‌توانند بسته به نیاز خود، تجهیزات جانبی مختلف را به‌راحتی به برد متصل کنند.
...
<Tabs>
  ...
  <TabItem label="فیرموِر کارخانه (Factory Firmware)">
    ...
    <LinkCard
      ...
      title="راهنمای آپلود"
      description="راهنمای آپلود فیرم‌ور کارخانه NodeMCU-32S"
    />
  </TabItem>
</Tabs>
