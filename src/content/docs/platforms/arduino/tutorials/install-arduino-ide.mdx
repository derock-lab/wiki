...
description: "آموزش نصب Arduino IDE روی ویندوز، لینوکس و مک + آشنایی با محیط برنامه و چند ابزار مفید برای شبیه‌سازی و توسعه پروژه‌های آردوینو."
keywords: ["نصب Arduino IDE", "آموزش آردوینو", "Arduino IDE 2.0", "برنامه نویسی آردوینو", "شبیه ساز مدار آردوینو", "Processing آردوینو"]
...
<Tabs>
  ...
  <TabItem label="نسخه 1.9.18">
    ...
    {/* <LinkButton href="#" variant="link" icon='download' iconPlacement='start'>
      دانلود Android IDE 1.9.18 برای Linux
    </LinkButton>
    <LinkButton href="#" variant="link" icon='download' iconPlacement='start'>
      دانلود Android IDE 1.9.18 برایMacOS
    </LinkButton> */}
  </TabItem>
</Tabs>
...
<Steps>
1. **Processing**
      ![processing](https://www.luisllamas.es/wp-content/uploads/2013/10/processing.webp)
...
2. **Circuit**
      ![circuit](https://www.luisllamas.es/wp-content/uploads/2013/10/circuit.webp)
